...
public class EESignalSystem extends Fragment {
    protected CheckBox cb1,cb2,cb3,cb4,cb5,cb6,cb7,cb8;
    protected TextView tv,tv1;
    protected   float ttl;

    protected int v1,v2,v3,v4,v5,v6,v7,v8,total;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState)
    {
        final View view = inflater.inflate(R.layout.fragment_eesignal_system, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("EESignalAndSystem", (total));
        ttl=(total*100)/8;
        //  this.tv.setText(String.valueOf((ttl)));
        this.tv.setText("Progress:"+total+"/8");
