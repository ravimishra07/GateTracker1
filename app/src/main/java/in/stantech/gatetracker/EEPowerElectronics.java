...
public class EEPowerElectronics extends Fragment {
    protected   CheckBox cb1,cb2,cb3,cb4,cb5,cb6,cb7,cb8,cb9,cb10,cb11,cb12,cb13,cb14,cb15,cb16,cb17;
    protected    TextView tv,tv1;
    protected   float ttl;

    protected int v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,total;
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState)
    {
        final View view = inflater.inflate(R.layout.fragment_eepower_electronics, container, false);
    ...
    private void initialState() {
        ...
        total = (v1 + v2+ v3+v4+v5+v6+v7+v8+v9+v10+v11+v12+v13+v14+v15+v16+v17);

        savePreferences("EEPowerElectronics", (total));
        ttl=(total*100)/17;
        //  this.tv.setText(String.valueOf((ttl)));
        this.tv.setText("Progress:"+total+"/17");
