...
public class EEControlSystem extends Fragment {
    ...
    {
        final View view = inflater.inflate(R.layout.fragment_eecontrol_system, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("EEControlSystem", (total));
        ttl=(total*100)/15;
