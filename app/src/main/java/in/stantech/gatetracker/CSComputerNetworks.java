...
public class CSComputerNetworks extends Fragment {
    protected CheckBox cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8, cb9, cb10, cb11, cb12, cb13, cb14;
    protected TextView tv, tv1;
    protected float ttl;

    protected int v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14,  total;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_cscomputer_networks, container, false);
    ...
    private void initialState() {
        ...
        total = (v1 + v2 + v3 + v4 + v5 + v6 + v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14);

        savePreferences("CSComputerNetworks", (total));
        ttl = (total * 100) / 14;
        //  this.tv.setText(String.valueOf((ttl)));
        this.tv.setText("Progress:" + total + "/14");
