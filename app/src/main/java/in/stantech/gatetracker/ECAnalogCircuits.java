...
public class ECAnalogCircuits  extends Fragment {
    ...
    {
        final View view = inflater.inflate(R.layout.fragment_ecanalog_circuits, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("ECAnalog", (total));
        ttl=(total*100)/22;
