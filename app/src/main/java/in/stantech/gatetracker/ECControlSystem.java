...
public class ECControlSystem extends Fragment {
    ...
    {
        final View view = inflater.inflate(R.layout.fragment_eccontrol_system, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("ECControlSystem", (total));
        ttl=(total*100)/10;
