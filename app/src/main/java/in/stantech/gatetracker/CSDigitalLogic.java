...
public class CSDigitalLogic extends Fragment {
    protected CheckBox cb1, cb2, cb3, cb4, cb5, cb6;
    protected TextView tv, tv1;
    protected float ttl;

    protected int v1, v2, v3, v4, v5, v6, total;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_csdigital_logic, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("CSDigitalLogic", (total));
        ttl = (total * 100) / 6;
        //  this.tv.setText(String.valueOf((ttl)));
        this.tv.setText("Progress:" + total + "/6");
