...
public class EElectricAndElectronicMeasu extends Fragment {
    protected CheckBox cb1,cb2,cb3,cb4,cb5,cb6,cb7,cb8,cb9,cb10;
    protected TextView tv,tv1;
    protected   float ttl;

    protected int v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,total;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState)
    {
        final View view = inflater.inflate(R.layout.fragment_eelectric_and_electronic_measu, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("EEElectricalAndElectronicsMeasu", (total));
        ttl=(total*100)/10;
        //  this.tv.setText(String.valueOf((ttl)));
        this.tv.setText("Progress:"+total+"/10");
