...
public class EEAnalogandDigitalCircuits extends Fragment {
    ...
    {
        final View view = inflater.inflate(R.layout.fragment_eeanalogand_digital_circuits, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("EEAnalog", (total));
        ttl=(total*100)/19;
