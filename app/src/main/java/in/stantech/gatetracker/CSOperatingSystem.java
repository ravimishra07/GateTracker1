...
public class CSOperatingSystem extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_csoperating_system, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("CSOperatingSystem", (total));
        ttl = (total * 100) / 10;
