...
public class CSComputerOrganization extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_cscomputer_organization, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("CSComputerOrganization", (total));
        ttl = (total * 100) / 9;
