...
public class CSTheoryOfComputation extends Fragment {
    protected CheckBox cb1, cb2, cb3, cb4, cb6;
    protected TextView tv, tv1;
    protected float ttl;

    protected int v1, v2, v3, v4, v6, total;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_cstheory_of_computation, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("CSTheoryOfComputation", (total));
        ttl = (total * 100) / 5;
