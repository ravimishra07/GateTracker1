...
public class CSDataStructure extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_csdata_structure, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("CSDataStructures", (total));
        ttl = (total * 100) / 10;
