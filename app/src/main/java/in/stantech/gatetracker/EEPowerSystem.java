...
public class EEPowerSystem extends Fragment {
    ...
    {
        final View view = inflater.inflate(R.layout.fragment_eepower_system, container, false);
    ...
    private void initialState() {
        ...
        savePreferences("EEPowerSystem", (total));
        ttl=(total*100)/19;
